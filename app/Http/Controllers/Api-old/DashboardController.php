...
class DashboardController extends Controller
{
    ...
    { 
       ...
       // pre($sellcount); exit;
        ...
        return response()->json(compact('currentmonthname','sellcount','productcount','companymanagments','categories','warehousemanagments','returncount','total_profit','monthly_loss','sell_return_categories','sell_chart','return_chart','profit_chart','loss_chart','icon'));
    }
